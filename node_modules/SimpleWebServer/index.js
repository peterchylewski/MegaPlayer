...
// SimpleWebServer v 0.1 © 2014 by peter@boring.ch
...
var SimpleWebServer = function(pathToPublicHTML, port, options) {	
	...
	function requestHandler(req, res) {
		...
		switch (path.extname(fileName)) {
			case '.jpg':
			case '.jpeg':
				pathToFile = decodeURI(fileName);	
			break;
			default:
				pathToFile = _pathToPublicHTML + '/' + fileName;
		}
		
		_getFile(pathToFile, req, res, page404);
	};

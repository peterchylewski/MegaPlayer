...
var SimplePlayer = function() {
	...
	this.start = function(file) {
		...
		var options = ['-slave', '-idle', '-softvol', '-vo',  'null', '-volume', _volume, '-cache', '80', '-msglevel', 'statusline=6', '-msglevel', 'global=6'],
	...
	function _decodePlayerMessage(buffer) {
		...
		//console.log('_decodePlayerMessage');
		...
		function decode(s) {
			...
			if (audio !== undefined && audio !== null) {
				...
				info['AUDIO'] = {
					raw: audio,
					samplingFrequency: samplingInfo[1],
					samplingFrequencyUnit: samplingInfo[2],
